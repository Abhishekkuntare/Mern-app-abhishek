...
import "./ModalGetStarted.css";
import "./HCJ.css";

const ModalGetStarted = () => {
  return (
    <>
      <div className="modal_getStarted">
        <div className="modal_getStarted_intro">
          <div className="modal_getstarted_name">
            <h1>Abhishek P Kuntare</h1>
            <p>Creative Developer ( Web /App / Software) </p>
          </div>
        </div>
          ...
          <div className="illustration-editor">
            ...
            <div className="code code-css">
              ...
              <div className="code-content">
                <code>
                  <p className="line-1">
                    <span className="c-y">.rect back</span>{" "}
                  </p>
                  <br />
                  <p className="line-2">
        ...
        {/* <div className="modal_getstared_code_img">
          <div className="modal_getstared_code_name2">
            <h2>Frontend </h2>
            <img src={Code6} alt="" />
          </div>

          <div className="modal_getstared_code_name">
            <h2>Backend </h2>
            <img src={Code1} alt="" />
          </div>
        </div> */}
